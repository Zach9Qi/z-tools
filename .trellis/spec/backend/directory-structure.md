...
└── src/
    ...
    │                       # `#[cfg(any(windows, target_os = "linux", target_os = "macos"))]` PreviousForeground 托管状态 + remember_foreground / previous_foreground / activate_window
    ├── launcher/
    ...
    │   └── macos.rs        # 平台钩子:`#[cfg(target_os = "macos")]` NSWorkspace 前台应用 PID 查询与激活;无操作钩子
    ...
    │   └── macos.rs        # 平台专属:`#[cfg(target_os = "macos")]` NSPasteboard changeCount 轮询 run_monitor / stop_monitor、CGEvent send_paste 与辅助功能降级
